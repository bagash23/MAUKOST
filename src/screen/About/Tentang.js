        ...
        <View style = {styles.container} >
            ...
            <View style = {styles.bodyParaf} >
                <Text style = {styles.text} >
                    MAUKOST adalah aplikasi yang dapat digunakan untuk memesan kontrakan atau kamar. yang didirikan pada tahun 2022 dan dikembangkan oleh tim MAUKOST. 
                    Aplikasi ini dapat membantu para pemilik kontrakan atau pemilik kamar untuk mengelola kontrakan atau kamar yang mereka miliki.
                </Text>
