...
const HistoryKontrakan = () => {
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.textHeader}>History Kost-an</Text>
      <ScrollView>
            ...
            <View key={index} style={styles.body}>
              ...
              <View>
                <TouchableOpacity
                  ...
                  disabled={item.statusKonfirmasi === 'Konfirmasi'}>
                  <View
                    style={{
                      flexDirection: 'row',
                      alignItems: 'center',
                    ...
                    <MaterialCommunityIcons
                      ...
                      color="#000"
                    />
                    <Text style={styles.textKonfirmasi}>Buka Scan QR Code</Text>
                  </View>
                </TouchableOpacity>
              </View>
            </View>
